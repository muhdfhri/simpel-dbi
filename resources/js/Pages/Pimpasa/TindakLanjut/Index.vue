...
const applyFilter = () => {
    ...
    router.get('/pimpasa/tindak-lanjut', params, { preserveState: true, replace: true });
};
...
const resetFilter = () => {
    ...
    router.get('/pimpasa/tindak-lanjut', {}, { preserveState: false, replace: true });
};
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
                        <div class="relative w-full flex-1">
                            ...
                            <Input
                                ...
                                placeholder="Cari kode tiket, judul laporan, nomor registrasi UPT, atau desa..."
